...
set JARPATH=%APP_HOME%\lib\SoftwareApplication-0.0.1-SNAPSHOT.jar

@rem Execute SoftwareApplication
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SOFTWARE_APPLICATION_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%SOFTWARE_APPLICATION_EXIT_CONSOLE%" exit 1
exit /b 1
